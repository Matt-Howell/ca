          ...
          maxWidth={1400} justifyContent="space-between" mx="auto">
            <Flex>
              <Link
                ...
                alignItems="center"
              >
                <svg width="157" height="27" viewBox="0 0 157 27" fill="none" xmlns="http://www.w3.org2000/svg">
            ...
            <HStack display="flex" alignItems="center" spacing={1}>
              ...
              >
                <Link href="/#Features" _hover={{ textDecoration:"none" }}><Button fontFamily={"'Montserrat', sans-serif!important"} variant="ghost">Features</Button></Link>
                <Link href="/#Pricing" _hover={{ textDecoration:"none" }}><Button fontFamily={"'Montserrat', sans-serif!important"} variant="ghost">Pricing</Button></Link>
                <Link href="/sign-in" _hover={{ textDecoration:"none" }}><Button fontFamily={"'Montserrat', sans-serif!important"} variant="ghost">Sign In</Button></Link>
              </HStack>
              ...
              >
                ...
                >
                  ...
                  />
                <Link href="/#Features" _hover={{ textDecoration:"none" }}><Button w={"full"} fontFamily={"'Montserrat', sans-serif!important"} variant="ghost">Features</Button></Link>
                <Link href="/#Pricing" _hover={{ textDecoration:"none" }}><Button w={"full"} fontFamily={"'Montserrat', sans-serif!important"} variant="ghost">Pricing</Button></Link>
                <Link href="/sign-in" _hover={{ textDecoration:"none" }}><Button w={"full"} fontFamily={"'Montserrat', sans-serif!important"} variant="ghost">Sign In</Button></Link><Link href="/sign-up" _hover={{ textDecoration:"none" }}><Button colorScheme="blue" w={"full"} fontFamily={"'Montserrat', sans-serif!important"} variant="solid">Get Started</Button></Link>
                </VStack>
              </Box>
            </HStack>
          </Flex>
