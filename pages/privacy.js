...
export default function Privacy() { 
  return (
    <div>
      <Head>
        <link rel="canonical" href="https://churnaxe.com/privacy" />

        <title>Privacy - ChurnAxe</title>
        <meta name="description" content="At ChurnAxe, we put our users first. To keep you in the know, here is our privacy policy - detailing the data we collect and how we use it." />

        <meta name="twitter:title" content="Privacy - ChurnAxe" />
        <meta name="twitter:description" content="At ChurnAxe, we put our users first. To keep you in the know, here is our privacy policy - detailing the data we collect and how we use it." />
        <meta name="twitter:image" content="https://churnaxe.com/s/i/CA-512.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={`https://churnaxe.com/privacy`}/>

        <meta property="og:title" content="Privacy - ChurnAxe" />
        <meta property="og:description" content="At ChurnAxe, we put our users first. To keep you in the know, here is our privacy policy - detailing the data we collect and how we use it." />
        <meta property="og:image" content="https://churnaxe.com/s/i/CA-512.png" />
        <meta property="og:url" content={`https://churnaxe.com/privacy`}/>
          ...
          <Box width="100%" padding="1rem 0" bg={'#f0f5f9'}>
            <Container maxW={'5xl'}>
              <Stack
                ...
                At ChurnAxe, we put our users first. To keep you in the know, here is our privacy policy - detailing the data we collect and how we use it. 🔒
                </Text>
              </Stack>
            </Container>
          </Box>
          <Container pt={5} maxW={'1500px'}>
          <Text color={'gray.600'} fontSize={"lg"}>At ChurnAxe, accessible from churnaxe.com, one of our main priorities is the privacy of our visitors. This privacy policy document contains types of information that is collected and recorded by ChurnAxe and how we use it.</Text><br />
...
<Text color={'gray.600'} fontSize={"lg"}>This privacy policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in ChurnAxe. This policy is not applicable to any information collected offline or via channels other than this website.</Text><br />
...
<Text color={'gray.600'} fontSize={"lg"}>Like any other website, ChurnAxe uses &apos;cookies&apos;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.</Text><br />
...
<Text color={'gray.600'} fontSize={"lg"}>ChurnAxe&apos;s privacy policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </Text><br />
