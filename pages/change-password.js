...
export default function PasswordChange() {
  ...
  return (
    <div>
      <Head>
        <link rel="canonical" href="https://churnaxe.com/change-password" />

        <title>Change Your Password - ChurnAxe</title>
        ...
        <meta name="twitter:title" content="Change Your Password - ChurnAxe" />
        ...
        <meta property="twitter:url" content={`https://churnaxe.com/change-password`}/>

        <meta property="og:title" content="Change Your Password - ChurnAxe" />
        ...
        <meta property="og:url" content={`https://churnaxe.com/change-password`}/>
