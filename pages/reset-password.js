...
export default function ResetPassword() {  
  ...
  const resetPassword = async () => {
    try {
      ...
      await supabase.auth.resetPasswordForEmail(email, {
        redirectTo: 'https://churnaxe.com/change-password',
      }).then(() => {
        toast({
            title: "Email Sent!",
  ...
  return (
    <div>
      <Head>
        <link rel="canonical" href="https://churnaxe.com/reset-password" />

        <title>Reset Password - ChurnAxe</title>
        <meta name="description" content="Reset your password in seconds to get back into your account." />
        
        <meta name="twitter:title" content="Reset Password - ChurnAxe" />
        ...
        <meta property="twitter:url" content={`https://churnaxe.com/reset-password`}/>
        
        <meta property="og:title" content="Reset Password - ChurnAxe" />
        ...
        <meta property="og:url" content={`https://churnaxe.com/reset-password`}/>
