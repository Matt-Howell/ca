...
export default function SignUp() {  
  ...
  return (
    <div>
      <Head>
        <link rel="canonical" href="https://churnaxe.com/sign-up" />

        <title>Sign Up - ChurnAxe</title>
        <meta name="description" content="Create an account in seconds to start tracking, analyzing, and cutting down your churn." />

        <meta name="twitter:title" content="Sign Up - ChurnAxe" />
        <meta name="twitter:description" content="Create an account in seconds to start tracking, analyzing, and cutting down your churn." />
        <meta name="twitter:image" content="https://churnaxe.com/s/i/CA-512.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={`https://churnaxe.com/sign-up`}/>

        <meta property="og:title" content="Sign Up - ChurnAxe" />
        <meta property="og:description" content="Create an account in seconds to start tracking, analyzing, and cutting down your churn." />
        <meta property="og:image" content="https://churnaxe.com/s/i/CA-512.png" />
        <meta property="og:url" content={`https://churnaxe.com/sign-up`}/>
